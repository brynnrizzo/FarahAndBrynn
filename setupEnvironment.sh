...
export LBC_GROUP_NAME=javagems
export LBC_REPO_NAME=ata-lbc-project-brynnrizzo

# Do not modify the rest of these unless you have been instructed to do so.
export LBC_PROJECT_NAME=lbcproject
export LBC_PIPELINE_STACK=$LBC_PROJECT_NAME-javagems
export LBC_ARTIFACT_BUCKET=$LBC_PROJECT_NAME-javagems-artifacts
export LBC_DEPLOY_STACK=$LBC_PROJECT_NAME-javagems-application
export LBC_APPLICATION_NAME=$LBC_PROJECT_NAME-javagems-application
export LBC_ENVIRONMENT_NAME=$LBC_PROJECT_NAME-javagems-environment-dev
